  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: ChoiceChip(
        ...
        labelStyle: TextStyle(color: selected ? IColors.white : null),
        avatar: isColor ? ICircularContainer(width: 50, height: 50, backgroundColor: IHelperFunctions.getColor(text)!) : null,
