    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            // Headings
            Text(ITexts.forgetPasswordTitle, style: Theme.of(context).textTheme.headlineLarge),
            const SizedBox(height: ISizes.spaceBtwItems),
            Text(ITexts.forgetPasswordSubTitle, style: Theme.of(context).textTheme.labelMedium),
